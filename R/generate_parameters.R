...
generate_parameters <- function(cols = 200,
  ...
  data.frame(
    ...
    value = c(
      ...
      corr_N_P, corr_N_LMA, corr_P_LMA, leafdem_resolution,
      p_tfsecondary, hurt_decay, crown_gap_fraction,
      m, m1, Cair, LL_parameterization,
      LA_regulation, sapwood, seedsadditional,
      NONRANDOM, Rseed, GPPcrown, BASICTREEFALL, SEEDTRADEOFF,
      CROWN_MM, OUTPUT_extended, extent_visual,
      fecundity, Rrecruit, distdisperse, torus, MinLAImax, MaxLAImax, CustomPhenology,
      MonthlySeedUpdate, SeedBoosting
    ),
    description = c(
      "/* nb of columns */",
      "/* nb of rows  */",
